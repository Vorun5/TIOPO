...
class _$_Answer implements _Answer {
  _$_Answer({required this.status, this.id = null});
  ...
  @override
  String toString() {
    return 'Answer(status: $status, id: $id)';
  }
...
abstract class _Answer implements Answer {
  factory _Answer({required final int status, final int? id}) = _$_Answer;
